...
window.DATA = {
  ...
  questions: [
    ...
    /* --- STAGE 2: EVENTS --- */
    {
      ...
      rows: [
        { id: 'pump', label: 'Pump', curve: 'standard', causes: ['R41', 'R42'] },
        { id: 'valves', label: 'Valves', curve: 'fast', causes: ['R71', 'R72', 'R73'] },
        { id: 'relay', label: 'Pump-start relay', curve: 'standard', causes: ['R31'] },
        { id: 'ctrl', label: 'Controller', curve: 'standard', causes: ['R12', 'R22', 'R23'] },
        { id: 'spr', label: 'Rotors', curve: 'standard', causes: ['R91'] },
      ],
    },
    {
      id: 'E3',
