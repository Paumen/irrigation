...
- **Ranking:** Every answer adds to or subtracts from each suspect cause; the engine recomputes scores and percentages after each answer, sorted most- to least-likely.
