...
![PGV cutaway — the solenoid (right) threads into the bonnet; its plunger covers the port that drains the upper chamber above the diaphragm. Flow runs inlet → outlet, left to right.](../media/valve_auto_breakdown_solenoid_port_cutaway.jpg)
...
![Turning the solenoid by hand](../media/valve_auto_instruction_solenoid_manual_turn.gif)
...
![Testing solenoid voltage with a multimeter](../media/valve_auto_instruction_solenoid_voltage_test.png)

![Stanley FATMAX with leads attached — black to COM, red to VΩ port.](../media/multimeter_product_stanley_fmht82563.jpg)
...
![Bonnet, spring, diaphragm and support ring lifted out; exhaust port in the valve body](../media/valve_auto_breakdown_exhaust_port.png)
...
![Replacement valve solenoid — black cylindrical body, looped 24 V leads, threaded base with O-ring. Form factor matches the PGV; verify coil resistance (20–60 Ω) and thread before swapping.](../media/valve_auto_product_solenoid_replacement.jpg)
...
![The solenoid's two leads at the meter — one to the shared common, one to the station's power wire.](../media/valve_auto_instruction_solenoid_voltage_test.png)
