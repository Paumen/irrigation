...
- **Wire connector**: little blue/white gel-filled splice on the 24 V wires → 3M Scotchlok 314 (blue cap stamped "3M 314"). For naming/synonyms and buying spares, see `knowledge/wiring.md` → *The connector itself*; image `IMG.wiring_product_3m_connector_314`.
