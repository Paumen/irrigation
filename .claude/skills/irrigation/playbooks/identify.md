...
"What relay is this? Is this an MP Rotator or an I-20? What nozzle's in this rotor?" `system.yaml` already says what they *should* have, so there are two cases:
...
This homeowner's kit (cache — read `system.yaml` for live values): controller RainMachine HD-16 TOUCH, relay Hunter PSR-22, pump DAB Aquajet 132M, four Hunter PGV-101G valves, Hunter I-20-04-SS rotors, Pro-Spray PRS40 bodies carrying MP Rotators.

If `system.yaml` and what they see disagree, offer to update the file — don't argue. If you can't pin the model, say so and ask for the label or a photo rather than guessing.
